...
<head>
    ...
    <link rel="stylesheet" href="src/../public/css/mystyle.css"/>
...
<body>
    ...
    <form id="inscription" method="POST" action="../../src/controllers/controllerclient.php">
        <legend>
    ...
    <script src="src/../public/js/client.js "></script>
</body>
